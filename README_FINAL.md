...
## ROAD-RACE GAMEPLAY
The race screen now has active driving:
- A / D or Left / Right = steer between 4 lanes
- W / Up = accelerate
- S / Down = brake
- Touch buttons = left / brake / right
- Traffic vehicles move toward the player
- Collision costs a life
- Correct answers increase target speed
- Wrong answers reduce target speed
- Turbo gives a speed burst
The question remains the primary academic challenge.
